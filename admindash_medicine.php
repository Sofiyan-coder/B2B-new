...
<body>
      ...
      <div class="input-group-append">
        <button class="btn" type="submit" id="button-addon2">GO</button>
                  ...
                  <div class="col-sm-6 p-0 d-flex justify-content-lg-end justify-content-center" >
                    <a href="Medicine.php" class="btn btn-success" >
  ...
  if (!empty($searchQuery)) {
    $query .= " WHERE M_nm LIKE '%$searchQuery%'";
  }
  ...
  ?>
      ...
      <td><?php echo $serialNumber; ?></td>
        <td><?php echo $row['M_nm']; ?></td>
        <td>
        <a href="edit_medicine.php?updateid=<?php echo $row['M_id']; ?>" class="edit">
            <i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
            <a href="delete_medicine.php?M_id=<?php echo $row['M_id']; ?>" class="delete" onclick="return confirm('Are you sure you want to delete this record?')">
