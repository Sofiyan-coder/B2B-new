...
<body>
      ...
      <div class="input-group-append">
        <button class="btn" type="submit" id="button-addon2">GO</button>
                  ...
                  <div class="col-sm-6 p-0 d-flex justify-content-lg-end justify-content-center" >
                    <a href="city.php" class="btn btn-success" >
 ...
 if (!empty($searchQuery)) {
   $query .= " WHERE C_nm LIKE '%$searchQuery%'";
 }
 ...
 if ($result) {
  ...
  ?>
      ...
      <td><?php echo $serialNumber; ?></td>
        <td><?php echo $row['C_nm']; ?></td>
        <td>
        <a href="edit_city.php?updateid=<?php echo $row['C_id']; ?>" class="edit">
            <i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
            <a href="delete_location.php?C_id=<?php echo $row['C_id']; ?>" class="delete" onclick="return confirm('Are you sure you want to delete this record?')">
