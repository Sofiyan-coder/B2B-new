...
<body>
      ...
      <div class="input-group-append">
        <button class="btn" type="submit" id="button-addon2">GO</button>
                  ...
                  <div class="col-sm-6 p-0 d-flex justify-content-lg-end justify-content-center" >
                    <a href="District.php" class="btn btn-success" >
  ...
  if (!empty($searchQuery)) {
    $query .= " WHERE D_nm LIKE '%$searchQuery%'";
  }
  ...
  ?>
      ...
      <td><?php echo $serialNumber; ?></td>
        <td><?php echo $row['D_nm']; ?></td>
        <td>
        <a href="edit_district.php?updateid=<?php echo $row['D_id']; ?>" class="edit">
            <i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
            <a href="delete_location.php?D_id=<?php echo $row['D_id']; ?>" class="delete" onclick="return confirm('Are you sure you want to delete this record?')">
