...
<button type="submit" name="add_subcategory" value="add_subcategory">Add Subcategory</button>
<br><br>
...
if (isset($_POST['add_subcategory'])) {
  ...
  $sql = "INSERT INTO subcategory (C_id, S_nm) VALUES ('$category_id','$sub_category_name')";
