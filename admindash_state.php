...
<body>
      ...
      <div class="input-group-append">
        <button class="btn" type="submit" id="button-addon2">GO</button>
                  ...
                  <div class="col-sm-6 p-0 d-flex justify-content-lg-end justify-content-center" >
                    <a href="State.php" class="btn btn-success" >
  ...
  ?>
      ...
      <td><?php echo $serialNumber; ?></td>
        ...
        <td>
        <a href="edit_state.php?updateid=<?php echo $row['S_id']; ?>" class="edit">
            <i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
            <a href="delete_location.php?S_id=<?php echo $row['S_id']; ?>" class="delete" onclick="return confirm('Are you sure you want to delete this record?')">
