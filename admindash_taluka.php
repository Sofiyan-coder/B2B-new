...
<body>
      ...
      <div class="input-group-append">
        <button class="btn" type="submit" id="button-addon2">GO</button>
                  ...
                  <div class="col-sm-6 p-0 d-flex justify-content-lg-end justify-content-center" >
                    <a href="Taluka.php" class="btn btn-success" >
 ...
 if (!empty($searchQuery)) {
   $query .= " WHERE T_nm LIKE '%$searchQuery%'";
 }
 ...
 if ($result) {
  ...
  ?>
      <tr>
        ...
        <td><?php echo $row['T_nm']; ?></td>
        <td>
        <a href="edit_taluka.php?updateid=<?php echo $row['T_id']; ?>" class="edit">
            <i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
            <a href="delete_location.php?T_id=<?php echo $row['T_id']; ?>" class="delete" onclick="return confirm('Are you sure you want to delete this record?')">
    <i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i>
</a>
        </td>
      </tr>
      <?php
        $serialNumber++; // Increment the serial number after each record
      }
    } else {
